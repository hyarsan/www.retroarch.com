    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 abstract">
                ...
                <p>RetroArch/Libretro is a big project that consumes a lot of our resources and time. An impressive amount of spinoff products and derivatives (the vast majority not even affiliated with our project) all depend on its continuing development and online services.</p>
                <p>To keep the show ongoing, there are various ways you can support the project.</p>
            </div>
        </div>
    </div>
</div>
...
<div class="doc">
    ...
    <div class="blockchain stage-error">
     ...
     <p>It borders on cliche at this point, but it really is true - this project is wholly community-funded, and the users' continued patronage keeps this project possible to keep existing. Server costs keep escalating, so does the amount of bandwidth we use up as more and more spinoff projects keep depending on our infrastructure. And, most importantly, to maintain all this and to keep doing new developments cost a vast amount of time investment. </p>
     </div>
</div>
